...
import zhCn from 'farst-three/dist/locale/zh-cn.mjs'
...
```html
<script src="//unpkg.com/farst-three/dist/locale/zh-cn"></script>
<script>
  app.use(ElementPlus, {
...
[Supported Language List](https://github.com/farst-three/farst-three/tree/dev/packages/locale/lang)
...
If you need any other languages, [PR](https://github.com/farst-three/farst-three/pulls)
is always welcomed, you only need to add a language file at
[here](https://github.com/farst-three/farst-three/tree/dev/packages/locale/lang).
