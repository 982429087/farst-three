...
import { docsDirName } from '@farst-three/build-utils'
...
const setupConfig = (configEnv) => {
  const config: UserConfig<any> = {
    ...
    themeConfig: {
      ...
      logo: '/images/farst-three-logo.svg',
      logoSmall: '/images/farst-three-logo-small.svg',
      sidebars,
      nav,
      agolia: {
    ...
    cleanUrls: true,
    sitemap: {
      hostname: 'https://farst-three.org',
    },
    locales,
